...
#pragma warning restore 414
		...
		private double InternalDecrypt()
		{
			...
			if (Detectors.ObscuredCheatingDetector.ExistsAndIsRunning && fakeValueActive && 
			    !IsEqual(decrypted, fakeValue, Detectors.ObscuredCheatingDetector.Instance.doubleEpsilon))
			{
