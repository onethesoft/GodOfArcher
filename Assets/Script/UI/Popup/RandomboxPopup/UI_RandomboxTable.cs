...
public class UI_RandomboxTable : UI_Popup
{
    ...
    public override void Init()
    {
        ...
        {
            Util.GetOrAddComponent<UI_RandomboxTableItem>(Managers.Resource.Instantiate($"UI/SubItem/RandomboxPopup/UI_RandomboxTableItem", Get<GameObject>((int)GameObjects.ItemTable).transform)).Set((int)_level, _mode);
